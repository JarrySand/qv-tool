      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-end justify-center gap-8 mb-6">
          ...
          <div className="text-center">
            <p className="mb-3 text-sm text-muted-foreground">{t.normalVoting}</p>
            <div className="flex justify-center gap-1 mb-2 h-20 items-end">
              {Array.from({ length: demoVotes }).map((_, i) => (
                <div
                  key={i}
                  className="w-5 h-5 rounded bg-muted-foreground/30 transition-all duration-300"
                />
              ))}
            </div>
          ...
          <div className="text-2xl text-muted-foreground pb-8">vs</div>
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center mb-2 h-20 items-end">
              <div
              ...
              >
                {Array.from({ length: cost }).map((_, i) => (
                  <div
                    key={i}
                    className={cn(
                      "w-4 h-4 rounded-sm bg-primary transition-all duration-200",
