      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>{t("vote.errors.authRequired")}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {process.env.GOOGLE_CLIENT_ID &&
              (!requiredProvider || requiredProvider === "google") && (
                <form
                  action={async () => {
                    "use server";
            ...
            {process.env.LINE_CLIENT_ID &&
              (!requiredProvider || requiredProvider === "line") && (
                ...
                >
                  <Button
                    type="submit"
                    className="h-12 w-full bg-[#00B900] text-white hover:bg-[#00A000]"
                  >
                    <svg
            ...
            {process.env.DISCORD_CLIENT_ID &&
              (!requiredProvider || requiredProvider === "discord") && (
                <form
                  action={async () => {
                    "use server";
